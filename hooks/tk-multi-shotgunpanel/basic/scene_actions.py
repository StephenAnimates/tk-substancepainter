...
# TODO NEEDS TO BE CONFIGURED AND SET UP FOR SUBSTANCE PAINTER IF IT'S NEEDED
# This will add a cutom configuration to handle panels in the asset step
# and project configurations. So rather than looking for the standard config
# the tk-multi-shotgunpanel settings will be in the
# "tk-multi-shotgunpanel/basic/scene_actions.py" file
#
# Update the configuration in asset_step.yml
# FROM:
...
#
# Update the configuration in project.yml
# FROM:
# tk-multi-shotgunpanel: '@common.apps.tk-multi-shotgunpanel'
# TO:
# tk-multi-shotgunpanel: '@substancepainter.apps.tk-multi-shotgunpanel'
#
# Update the configuration in apps.yml
# ADD:
# substancepainter.apps.tk-multi-shotgunpanel:
#   hook_scene_operations: "{engine}/tk-multi-shotgunpanel/basic/scene_actions.py"
#   location: '@substancepainter.apps.tk-multi-shotgunpanel.location'
